                ...
                <ul>
                    <li>
                        <form action='facultyCourses.php'>
                            <input style='float:left;' type='submit' value='Back to Courses' class='btn btn-light'>
                        </form>
                    </li>
        ...
        <div class="form_holder">
            <form action="../GradeUpdate.php">
                ...
                <div class="input_field">
                    <input placeholder="Input a valid grade" type="text" name="grade" required /><br>
                </div>
                ...
                <div class="btn_wrapper">
                    <input type="hidden" class="btn btn-light" name="class_crn" value="<?php echo $_GET["class_crn"] ?>" />
                </div>
                <input type="submit">
            </form>
        </div>
